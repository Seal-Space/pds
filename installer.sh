...
COMPOSE_URL="https://raw.githubusercontent.com/Seal-Space/pds/main/compose.yaml"

# The pdsadmin script.
PDSADMIN_URL="https://raw.githubusercontent.com/Seal-Space/pds/main/pdsadmin.sh"
